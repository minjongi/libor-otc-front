      ...
      >
        <div className="container mw-1680">
          ...
          >
            ...
            <h1 className="text-align pt-2">{t('banner_explain_2')}</h1>

            <div className="banner-info p-5"
                 style={{ maxWidth: "650px", marginLeft: "650px"}}
            >
              <p>
                <span style={{fontWeight: "bold"}}>{t('banner_explain_3')}</span> <br />
                  {t('banner_explain_4')}
              </p>
              <p>
                <span style={{fontWeight: "bold"}}>{t('banner_explain_5')}</span> <br />
                  {t('banner_explain_6')}
              </p>
              <p>
                <span style={{fontWeight: "bold"}}>{t('banner_explain_7')}</span> <br />
                  {t('banner_explain_8')}
              </p>
              <p>
                <span style={{fontWeight: "bold"}}>{t('banner_explain_9')}</span> <br />
                  {t('banner_explain_10')}
              </p>
              ...
              <div className="d-flex align-items-center gap-30 gap-2 info-btn">
                ...
                <div>
                  <span className="d-block">{t('banner_explain_11')}</span>
                  <a
